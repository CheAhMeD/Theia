...
#define GUI_CMAP_PALETTE_DEFAULT  3
// Available palettes
...
#define PS_RAM_SIZE               16   //Number of bytes
#define PS_RAM_IMG_SUFFIX_ADDR    0x00 // 2 bytes
#define PS_RAM_PALETTE_NUM        0x02 // 1 byte
#define PS_RAM_LEP_GAIN_MODE      0x03 // 1 byte
#define PS_RAM_LEP_TEMP_UNIT      0x04 // 1 byte
#define PS_RAM_LEP_IMG_FORMAT     0x05 // 1 byte
#define PS_RAM_SYS_STATUS_LSB     0x06 // 1 byte
#define PS_RAM_SYS_STATUS_MSB     0x07 // 1 byte
