...
extern bool get_var_agc_mode_trig();
extern void set_var_agc_mode_trig(bool trig);
extern bool get_var_rad_mode_trig();
extern void set_var_rad_mode_trig(bool trig);
